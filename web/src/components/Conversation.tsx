import { ConvoQuoteRotor } from "./ConvoQuoteRotor";
  ...
  return (
    <section className="convo">
      <div className="convo-inner">
        <Reveal className="convo-quote-col">
          <ConvoQuoteRotor />
        </Reveal>
        ...
        <Reveal delay={2}>
          ...
          <p className="convo-lead">
            Every platform makes you fill in fields. Mitra has a real
            conversation on WhatsApp, where you already are. A conversation
            surfaces{" "}
            <strong className="convo-strong">intent</strong>
            , and intent is what determines whether an introduction becomes an
            offer.
          </p>
          ...
          >
            ...
            <div className="chat-body">
              ...
              <div
                className="cm"
                style={{ animation: "up .4s .4s both", opacity: 0 }}
              >
              ...
              <div
                className="cm out"
                style={{ animation: "up .4s 1.0s both", opacity: 0 }}
              >
                <div className="cm-av u">Y</div>
                <div className="cm-bub out-b">
                  3 years at Infosys maintaining legacy code. I want to
                  actually build something that matters.
                </div>
              </div>
              <div
                className="cm"
                style={{ animation: "up .4s 1.7s both", opacity: 0 }}
              >
                <div className="cm-av m">M</div>
                <div className="cm-bub in">
                  <strong>
                    What&apos;s the last thing you built that you were
                    genuinely proud of?
                  </strong>
                </div>
              </div>
              <div
                className="cm out"
                style={{ animation: "up .4s 2.4s both", opacity: 0 }}
              >
                <div className="cm-av u">Y</div>
                <div className="cm-bub out-b">
                  A real-time fraud detection pipeline. Nobody asked me to.
                  Cut false positives by 40%.
                </div>
              </div>
              <div
                className="cm"
                style={{ animation: "up .4s 3.1s both", opacity: 0 }}
              >
                <div className="cm-av m">M</div>
                <div className="cm-bub in">
                  That tells me exactly the environment where you&apos;ll
                  thrive. <strong>2 strong matches:</strong>
